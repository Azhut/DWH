...
class DataRetrievalService:
    def __init__(self, filter_service: FilterService):
        ...
        self.sheets_repo = SheetsRepository(db.get_collection("Sheets"))
...
def create_data_retrieval_service():
    ...
    """
    db = mongo_connection.get_database()
    sheets_repo = SheetsRepository(db.get_collection("Sheets"))
    flat_data_repo = FlatDataRepository(db.get_collection("FlatData"))
    filter_service = FilterService(sheets_repo, flat_data_repo)
